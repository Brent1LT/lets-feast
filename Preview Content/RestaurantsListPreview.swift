...
var restaurant1 = Restaurant(id: "1", name: "AdCG2DPX03TePJ6qVXiJmcLgTr3mw5AkmS0KSMPW_vEvA3ZI8hLr4V1EHuMh9jWdXYu5N_dXR6OWFUnMO7GISSsDENmDNmyr6POJAx_8gEJ7TFKyKbejY4IM2_3duNGyMdwHyZH22kaZmRRc7Rdh8MjfLBAd18RFPN65xIB5j5-xBTl8UL_Z", photos: [jack], rating: 4.5, geometry: geometry1)
var restaurant2 = Restaurant(id: "2", name: "Sushi Palace", photos: [subway], geometry: geometry2)
var restaurant3 = Restaurant(id: "3", name: "Burger Town", photos: [panda], geometry: geometry3)
var restaurant4 = Restaurant(id: "4", name: "Pasta House", photos: [donalds], geometry: geometry4)
var restaurant5 = Restaurant(id: "5", name: "Taco Fiesta",photos: [jack], geometry: geometry5)
var restaurant6 = Restaurant(id: "6", name: "Pizza Place", photos: [], geometry: geometry6)
